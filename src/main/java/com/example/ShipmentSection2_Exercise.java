...
class Shipment {
    ...
    public String toString() {
        return "[" + trackingNumber + "] " + weightKg + " กก." + " | " + "STANDARD" + " | " + calculateCost() + " บาท";  // ← เติมให้ครบ
    }
}
...
class ShippingCompany {
    ...
    public double getTotalCost() {
        ...
        for (Shipment shipment_cost : shipments){
        	total += shipment_cost.calculateCost();
        }
        return total;
    }
    ...
    public void printSummary() {
        ...
        for (Shipment any_shipments : shipments) {
        	System.out.println(any_shipments);
        }
        System.out.println("----------------------------------------");
        // 2) แสดงยอดรวมตรงนี้
        System.out.println("Total Shipments: " + getTotalCost());
    }
}
